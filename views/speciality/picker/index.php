    ...
    <div class="row">
        <div class="col-md-12">
            ...
            ListView::widget([
                ...
                'layout' => '<table class="data-table picker-items"><thead class="h-sort">{sorter}</thead><tbody>{items}</tbody><tfoot><tr><td colspan="1">{pager}</td></tr></tfoot></table>',
                'sorter' => [
...
<script>
    ...
    $(document).ready(function () {
        $('.picker-items .action-pick').on('click', function () {
            ...
            $(document).trigger('specPick.' + pickerTarget, data);
