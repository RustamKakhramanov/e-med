    ...
    <table>
                ...
                <div class="relation-picker" data-id="<?= $uid; ?>">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="search_input-ctr">
                            <?=
                            Html::input('text', '', $model->price_id ? $model->price->name : '', [
        ...
        <td class="rl_col_cost">
            <div class="form-group mb0 field-items-<?= $uid; ?>-cost">
                <?= Html::input('text', 'items[' . $uid . '][cost]', $model->cost, [
        ...
        <td class="rl_col_summ">
            <div class="form-group mb0">
                <input type="text" class="form-control input-summ" id="items-<?=$uid;?>-summ" value="" readonly=""/>
            </div>
        </td>
        <td class="rl_col_doctor">
            <div class="form-group mb0 field-items-<?= $uid; ?>-doctor_id">
                <?=
                Html::dropDownList('items[' . $uid . '][doctor_id]', $model->doctor_id, [], [
...
<script>
    $(document).ready(function () {
        ...
        $('#items-<?=$uid;?>-summ').on('change', function(){
            $(this).closest('form').trigger('recalcTotal');
        });
    });
</script>